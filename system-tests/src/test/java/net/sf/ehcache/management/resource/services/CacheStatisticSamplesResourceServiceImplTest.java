...
[
  {
    ...
    expect().contentType(ContentType.JSON)
            ...
            .body("find{it.get('cacheManagerName') == 'testCacheManagerProgrammatic'}.statName", equalTo("LocalHeapSize"))
            .body("find{it.get('cacheManagerName') == 'testCacheManagerProgrammatic'}.statValueByTimeMillis.size()", greaterThan(0))
            .body("find{it.get('cacheManagerName') == 'testCacheManagerProgrammatic'}.statValueByTimeMillis.values()[0]", greaterThan(0))
            .body("find{it.get('cacheManagerName') == 'testCacheManager'}.agentId", equalTo("embedded"))
            .body("find{it.get('cacheManagerName') == 'testCacheManager'}.name", equalTo("testCache"))
            .body("find{it.get('cacheManagerName') == 'testCacheManager'}.statName", equalTo("LocalHeapSize"))
            .body("find{it.get('cacheManagerName') == 'testCacheManager'}.statValueByTimeMillis.size()", greaterThan(0))
            .body("find{it.get('cacheManagerName') == 'testCacheManager'}.statValueByTimeMillis.values()[0]", greaterThan(0))
            .body("size()", is(2))
            .statusCode(200)
            .when().get(EXPECTED_RESOURCE_LOCATION, STANDALONE_BASE_URL,agentsFilter,cmsFilter,cachesFilter,samplesFilter);
  ...
  public void getCacheStatisticSamples__clustered() throws Exception {
    ...
    expect().contentType(ContentType.JSON)
            ...
            .body("find{it.get('cacheManagerName') == 'testCacheManagerProgrammatic'}.statValueByTimeMillis.size()", greaterThan(0))
            .body("find{it.get('cacheManagerName') == 'testCacheManagerProgrammatic'}.statValueByTimeMillis.values()[0]", greaterThan(0))
            .body("find{it.get('cacheManagerName') == 'testCacheManager'}.agentId", equalTo(agentId))
            .body("find{it.get('cacheManagerName') == 'testCacheManager'}.name", equalTo("testCache"))
            .body("find{it.get('cacheManagerName') == 'testCacheManager'}.statName", equalTo("LocalHeapSize"))
            .body("find{it.get('cacheManagerName') == 'testCacheManager'}.statValueByTimeMillis.size()", greaterThan(0))
            .body("find{it.get('cacheManagerName') == 'testCacheManager'}.statValueByTimeMillis.values()[0]", greaterThan(0))
